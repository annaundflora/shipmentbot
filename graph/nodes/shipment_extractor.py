...
# Importiere die Modelle aus dem neuen Pfad
from graph.nodes.shipment_models import Shipment, ShipmentItem, LoadCarrierType
...
def process_shipment(state: dict) -> dict:
    ...
    if prompt_template is None:
        return {
            "extracted_data": None,
            "message": "Fehler: Konnte den Prompt nicht laden."
        }
